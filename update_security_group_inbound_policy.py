...
# print(data)
sg_application_id = 'sg-0c7f9e00b8d1e18b2'
...
sg_devopschain_application_inbound = read_file(sg_devopschain_application_inbound_path)
sg_devopschain_application_inbound['securitygroupid'] = sg_application_id
try:
    app.ec2_security_group_inbound_policies_add(sg_devopschain_application_inbound)
